...
//Row 8
OSCMessage msgC1_R8_press("/location/1/8/1/press");
OSCMessage msgC1_R8_rotLeft("/location/1/8/1/rotate-left");
OSCMessage msgC1_R8_rotRight("/location/1/8/1/rotate-right");
...
//Row 8
OSCMessage msgC2_R8_press("/location/1/8/2/press");
OSCMessage msgC2_R8_rotLeft("/location/1/8/2/rotate-left");
OSCMessage msgC2_R8_rotRight("/location/1/8/2/rotate-right");
...
//Row 8
OSCMessage msgC3_R8_press("/location/1/8/3/press");
OSCMessage msgC3_R8_rotLeft("/location/1/8/3/rotate-left");
OSCMessage msgC3_R8_rotRight("/location/1/8/3/rotate-right");
...
//Row 8
OSCMessage msgC4_R8_press("/location/1/8/4/press");
OSCMessage msgC4_R8_rotLeft("/location/1/8/4/rotate-left");
OSCMessage msgC4_R8_rotRight("/location/1/8/4/rotate-right");
...
//Row 8
OSCMessage msgC5_R8_press("/location/1/8/5/press");
OSCMessage msgC5_R8_rotLeft("/location/1/8/5/rotate-left");
OSCMessage msgC5_R8_rotRight("/location/1/8/5/rotate-right");
...
//Row 8
OSCMessage msgC6_R8_press("/location/1/8/6/press");
OSCMessage msgC6_R8_rotLeft("/location/1/8/6/rotate-left");
